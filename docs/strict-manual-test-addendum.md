...
1. `BOOTH / GitHub Release` の公開画面または配布準備画面で、説明文、スクリーンショット、配布物の対応が分かること。
2. `Acrobat JavaScript + external evidence CLI` の主画面で、error と warning の違いが迷わず分かること。
...
- 実ホストアプリ上での UI 操作確認。
- BOOTH / GitHub Release の審査画面または掲載画面での最終確認。
